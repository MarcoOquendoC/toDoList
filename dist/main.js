...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _assets_scripts_methods_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/scripts/methods.js */ \"./src/assets/scripts/methods.js\");\n/* harmony import */ var _assets_scripts_status_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/scripts/status.js */ \"./src/assets/scripts/status.js\");\n/* import _ from 'lodash'; */\n\n\n\n\n_assets_scripts_methods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].setIndexes();\n_assets_scripts_methods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].render();\n\nconst form = document.querySelector('#form');\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const description = e.target.firstChild.nextSibling.value;\n  _assets_scripts_methods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].add(description);\n  e.target.firstChild.nextSibling.value = '';\n});\n\nconst list = document.querySelector('#list');\nlist.addEventListener('click', (e) => {\n  if (e.target.textContent === '🗑') {\n    let { id } = e.target.parentElement.parentElement;\n    id = Number(id.slice(1));\n    _assets_scripts_methods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].remove(id);\n    return;\n  }\n\n  if (e.target.textContent === '🖊') {\n    let { id } = e.target.parentElement.parentElement;\n    id = Number(id.slice(1));\n    _assets_scripts_methods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].toggleEdit(id);\n    e.target.classList.toggle('active');\n    e.target.parentElement.previousSibling.previousSibling.toggleAttribute('disabled');\n  }\n});\n\nlist.addEventListener('input', (e) => {\n  let { id } = e.target.parentElement;\n  id = Number(id.slice(1));\n  if (e.target.matches('.description')) {\n    _assets_scripts_status_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].changeDescription(e.target.value, id);\n    return;\n  }\n\n  if (e.target.matches('.check')) {\n    _assets_scripts_status_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].toggleComplete(id);\n  }\n});\n\nconst clearBtn = document.querySelector('.clear');\nclearBtn.addEventListener('click', () => {\n  _assets_scripts_status_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].clearCompleted();\n});\n\n//# sourceURL=webpack://webpack/./src/index.js?");
